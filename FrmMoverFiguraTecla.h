...
#pragma region Windows Form Designer generated code
		   void InitializeComponent(void)
		   {
			   ...
			   this->lblTiempo->Location = System::Drawing::Point(36, 475);
			   this->lblTiempo->Name = L"lblTiempo";
			   this->lblTiempo->Size = System::Drawing::Size(176, 38);
	...
	private:
		...
		System::Void timer_Tick(System::Object^ sender, System::EventArgs^ e) {
			...
			if (juegoService->getFiguraActual()->getLados() == 5 && !cambioTramo) {
				...
				FrmFiguraTramo2^ frmTramo2 = gcnew FrmFiguraTramo2(figuraActual, automatico, colorFigura, 10 - tiempoRestante);
				frmTramo2->Show();
